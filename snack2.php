    ...
    <div class="container">
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="mail" class="form-control" id="mailInput" aria-describedby="emailHelp" value='<?php echo $mail ?>' />
                <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
            </div>
            <div class="mb-3">
                <label for="ageInput" class="form-label">Age</label>
                <input type="number" class="form-control" id="ageInput" value='<?php echo $age ?>' />
            </div>
